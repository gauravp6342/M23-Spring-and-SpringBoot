...
public class CertificateController 
{
	...
	public ResponseEntity<Certificate> get(@PathVariable Integer cert_id)
	{
		try 
		{
			Certificate c=service.retrieve(cert_id);
	...
	public ResponseEntity<Certificate> update(@RequestBody Certificate c, @PathVariable Integer cert_id)
	{
		try 
		{
			Certificate c1=service.retrieve(cert_id);
			service.create(c);
